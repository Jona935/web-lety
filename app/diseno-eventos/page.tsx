    ...
    <>
      ...
      <section className="pt-36 pb-24 bg-ebony relative overflow-hidden">
        ...
        <div className="container-narrow relative z-10">
          <AnimatedSection>
            ...
            <p className="font-sans font-light tracking-[0.22em] uppercase text-sm text-taupe-light">Donde la creatividad y la elegancia se encuentran</p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="section-padding-sm bg-ebony">
        <div className="container-narrow text-center">
          <AnimatedSection>
            <p className="font-sans font-light tracking-[0.22em] uppercase text-sm text-taupe-light mb-4">¿Lista para diseñar tu evento?</p>
