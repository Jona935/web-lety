        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "¿Cuánto tiempo antes debo contratar sus servicios?",
                "acceptedAnswer": { "@type": "Answer", "text": "Para bodas recomendamos al menos 6-12 meses de anticipación para garantizar disponibilidad de proveedores y venues." }
              },
              {
                "@type": "Question",
                "name": "¿Cuánto cuesta contratar un wedding planner en Monclova?",
                "acceptedAnswer": { "@type": "Answer", "text": "Nuestros paquetes van desde el Esencial hasta el Grand, adaptados a cada presupuesto. La primera consulta es gratuita y sin compromiso." }
              },
              {
                "@type": "Question",
                "name": "¿Trabajan solo en Monclova?",
                "acceptedAnswer": { "@type": "Answer", "text": "No, atendemos Monclova, Cuatrociénegas, Minas de Mármol y toda la región Noreste de México." }
              },
              {
                "@type": "Question",
                "name": "¿Qué servicios incluye la coordinación de bodas?",
                "acceptedAnswer": { "@type": "Answer", "text": "Incluye planeación integral, diseño floral, banquetes, renta de mobiliario, coordinación el día del evento y diseño de experiencia personalizada." }
              }
            ]
          })
        }}
