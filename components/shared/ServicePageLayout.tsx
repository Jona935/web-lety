    ...
    <>
      ...
      <section className="pt-36 pb-24 bg-ebony relative overflow-hidden">
        ...
        <div className="container-narrow relative z-10">
          <AnimatedSection>
            ...
            <p className="font-script text-script-md text-taupe-light">{subtitle}</p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="section-padding-sm bg-ebony">
        <div className="container-narrow text-center">
          <AnimatedSection>
            <p className="font-script text-script-md text-taupe-light mb-4">¿Te interesa este servicio?</p>
