...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-[200] flex items-center gap-2.5 px-4 py-2.5 text-[10px] tracking-widest uppercase font-sans font-medium shadow-lg transition-all duration-300 border"
      style={{
